...
We can directly sample $x$ from $p_{\theta}$ to approximte the gradient. $f$ can be non-differentiable. In RLHF, $f$ is the reward funciton which is rarely differentiable.
